...
const N = 10;
  ...
  const world = Globe({ animateIn: false })(document.getElementById("globeViz"))
    .globeImageUrl("/static/img/globe/earth.jpg")
    .bumpImageUrl("/static/img/globe/bump.jpg")
    ...
    .htmlElement((d) => {
      ...
      el.innerHTML =
        ...
        zIndex +
        " position:relative;'><img style='transform:translate(-10px, 0); filter:drop-shadow(0px 0px 30px #ffffff60);' src='/static/img/miis/" +
        d.faces +
        "' alt='Team member' width='70px'><div style='display:" +
        isOpened +
        ...
        d.name +
        "</b> is playing </br><div style='display:flex; align-items:center; gap:10px;'><img style='top:0; right:0; transform:translate(0, -1px); postion:absolute;' src='/static/img/games/" +
        d.icons +
        "' alt='Game icon' width='20px' height='20px'> <b>" +
        d.game +
        "</b></div></div><img style='width:40px; height:40px; top:0; right:0; transform:translate(-15px, -15px); display:" +
        isClosed +
        "; postion:absolute;' src='/static/img/games/" +
        d.icons +
        "' alt='Game icon'></div>";
  ...
  // Add clouds sphere
  const CLOUDS_IMG_URL = "/static/img/globe/clouds.png";
